...
#
# 01_hola_mundo.tcl: Tcl script for re-creating project 'hola_mundo'
#
# Generated by Vivado on Sat Dec 27 14:59:33 +0100 2025
...
#
# 1. This project restoration tcl script (01_hola_mundo.tcl) that was generated.
#
...
set _xil_proj_name_ "hola_mundo"
...
set script_file "01_hola_mundo.tcl"
...
if { [get_property IS_LOCKED [ get_files -norecurse [list sistema.bd]] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/hola_mundo.gen/sources_1/bd/sistema/hdl/sistema_wrapper.v" ]
} else {
...
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/hola_mundo.srcs/utils_1/imports/synth_1" -objects $obj
...
set_property -name "auto_rqs.directory" -value "$proj_dir/hola_mundo.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "incremental_checkpoint.more_options" -value "" -objects $obj
set_property -name "include_in_archive" -value "1" -objects $obj
set_property -name "gen_full_bitstream" -value "1" -objects $obj
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/hola_mundo.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "min_rqa_score" -value "0" -objects $obj
