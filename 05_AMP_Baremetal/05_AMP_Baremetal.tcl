...
#
# 05_AMP_Baremetal.tcl: Tcl script for re-creating project '05_AMP_Baremetal'
#
# Generated by Vivado on Sun Dec 28 22:31:58 +0100 2025
...
#
# 1. This project restoration tcl script (05_AMP_Baremetal.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "D:/ProyectosVivado/05_AMP_Baremetal/05_AMP_Baremetal.srcs/constrs_1/new/constraints.xdc"
#    "D:/ProyectosVivado/05_AMP_Baremetal/05_AMP_Baremetal.srcs/utils_1/imports/synth_1/Sistema_wrapper.dcp"
#
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/../05_AMP_Baremetal/05_AMP_Baremetal.srcs/constrs_1/new/constraints.xdc"]"\
 "[file normalize "$origin_dir/../05_AMP_Baremetal/05_AMP_Baremetal.srcs/utils_1/imports/synth_1/Sistema_wrapper.dcp"]"\
  ]
  foreach ifile $files {
...
set _xil_proj_name_ "05_AMP_Baremetal"
...
set script_file "05_AMP_Baremetal.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/../05_AMP_Baremetal"]"
...
set file "[file normalize ${origin_dir}/../05_AMP_Baremetal/05_AMP_Baremetal.srcs/constrs_1/new/constraints.xdc]"
...
set file "synth_1/Sistema_wrapper.dcp"
...
proc cr_bd_Sistema { parentCell } {
  ...
  set_property -dict [list \
    ...
    CONFIG.PCW_MIO_TREE_PERIPHERALS {unassigned#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#unassigned#unassigned#unassigned#UART 0#UART 0#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#SD\
...
\
  ...
  # Create instance: axi_timer_1000ms, and set properties
  set axi_timer_1000ms [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_timer:2.0 axi_timer_1000ms ]
  set_property CONFIG.enable_timer2 {0} $axi_timer_1000ms
  ...
  # Create instance: axi_timer_500ms, and set properties
  set axi_timer_500ms [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_timer:2.0 axi_timer_500ms ]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins ps7_0_axi_periph/M01_AXI] [get_bd_intf_pins axi_timer_1000ms/S_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M02_AXI [get_bd_intf_pins ps7_0_axi_periph/M02_AXI] [get_bd_intf_pins axi_timer_500ms/S_AXI]

  # Create port connections
  connect_bd_net -net axi_timer_0_interrupt [get_bd_pins axi_timer_1000ms/interrupt] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net axi_timer_1_interrupt [get_bd_pins axi_timer_500ms/interrupt] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins axi_timer_1000ms/s_axi_aclk] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins axi_timer_500ms/s_axi_aclk] [get_bd_pins ps7_0_axi_periph/M02_ACLK]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_50M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins rst_ps7_0_50M/peripheral_aresetn] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins axi_timer_1000ms/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins axi_timer_500ms/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/M02_ARESETN]
  ...
  assign_bd_address -offset 0x42800000 -range 0x00010000 -with_name SEG_axi_timer_0_Reg -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_timer_1000ms/S_AXI/Reg] -force
  assign_bd_address -offset 0x42810000 -range 0x00010000 -with_name SEG_axi_timer_1_Reg -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_timer_500ms/S_AXI/Reg] -force
...
cr_bd_Sistema ""
set_property EXCLUDE_DEBUG_LOGIC "0" [get_files Sistema.bd ] 
set_property GENERATE_SYNTH_CHECKPOINT "0" [get_files Sistema.bd ] 
set_property IS_ENABLED "1" [get_files Sistema.bd ] 
set_property IS_GLOBAL_INCLUDE "0" [get_files Sistema.bd ] 
set_property LIBRARY "xil_defaultlib" [get_files Sistema.bd ] 
set_property PATH_MODE "RelativeFirst" [get_files Sistema.bd ] 
set_property PFM_NAME "" [get_files Sistema.bd ] 
set_property REGISTERED_WITH_MANAGER "1" [get_files Sistema.bd ] 
set_property SYNTH_CHECKPOINT_MODE "None" [get_files Sistema.bd ] 
set_property USED_IN "synthesis implementation simulation" [get_files Sistema.bd ] 
set_property USED_IN_IMPLEMENTATION "1" [get_files Sistema.bd ] 
set_property USED_IN_SIMULATION "1" [get_files Sistema.bd ] 
set_property USED_IN_SYNTHESIS "1" [get_files Sistema.bd ] 

#call make_wrapper to create wrapper files
if { [get_property IS_LOCKED [ get_files -norecurse [list Sistema.bd]] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/../05_AMP_Baremetal/05_AMP_Baremetal.gen/sources_1/bd/Sistema/hdl/Sistema_wrapper.v" ]
} else {
...
set_property -name "incremental_checkpoint" -value "$proj_dir/05_AMP_Baremetal.srcs/utils_1/imports/synth_1/Sistema_wrapper.dcp" -objects $obj
...
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/05_AMP_Baremetal.srcs/utils_1/imports/synth_1" -objects $obj
...
set_property -name "auto_rqs.directory" -value "$proj_dir/05_AMP_Baremetal.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "incremental_checkpoint.more_options" -value "" -objects $obj
set_property -name "include_in_archive" -value "1" -objects $obj
set_property -name "gen_full_bitstream" -value "1" -objects $obj
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/05_AMP_Baremetal.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "min_rqa_score" -value "0" -objects $obj
