...
#
# 03_AXI_Peripherals.tcl: Tcl script for re-creating project '03_AXI_Peripherals'
#
# Generated by Vivado on Sat Dec 27 15:02:35 +0100 2025
...
#
# 1. This project restoration tcl script (03_AXI_Peripherals.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "D:/ProyectosVivado/03_AXI_Peripherals/03_AXI_Peripherals.srcs/constrs_1/new/constraints.xdc"
#    "D:/ProyectosVivado/03_AXI_Peripherals/03_AXI_Peripherals.srcs/utils_1/imports/synth_1/Sistema_wrapper.dcp"
#
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/03_AXI_Peripherals.srcs/constrs_1/new/constraints.xdc"]"\
 "[file normalize "$origin_dir/03_AXI_Peripherals.srcs/utils_1/imports/synth_1/Sistema_wrapper.dcp"]"\
  ]
  foreach ifile $files {
...
set _xil_proj_name_ "03_AXI_Peripherals"
...
set script_file "03_AXI_Peripherals.tcl"
...
set file "[file normalize "$origin_dir/03_AXI_Peripherals.srcs/constrs_1/new/constraints.xdc"]"
...
if { [get_property IS_LOCKED [ get_files -norecurse [list Sistema.bd]] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/03_AXI_Peripherals.gen/sources_1/bd/Sistema/hdl/Sistema_wrapper.v" ]
} else {
...
set_property -name "incremental_checkpoint" -value "$proj_dir/03_AXI_Peripherals.srcs/utils_1/imports/synth_1/Sistema_wrapper.dcp" -objects $obj
...
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/03_AXI_Peripherals.srcs/utils_1/imports/synth_1" -objects $obj
...
set_property -name "auto_rqs.directory" -value "$proj_dir/03_AXI_Peripherals.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "incremental_checkpoint.more_options" -value "" -objects $obj
set_property -name "include_in_archive" -value "1" -objects $obj
set_property -name "gen_full_bitstream" -value "1" -objects $obj
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/03_AXI_Peripherals.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "min_rqa_score" -value "0" -objects $obj
