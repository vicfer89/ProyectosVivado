...
#
# 02_Prueba_EMIO.tcl: Tcl script for re-creating project '02_Prueba_EMIO'
#
# Generated by Vivado on Sat Dec 27 15:00:57 +0100 2025
...
#
# 1. This project restoration tcl script (02_Prueba_EMIO.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "D:/ProyectosVivado/02_Prueba_EMIO/02_Prueba_EMIO.srcs/constrs_1/new/Navigator.xdc"
#
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/../02_Prueba_EMIO/02_Prueba_EMIO.srcs/constrs_1/new/Navigator.xdc"]"\
  ]
  foreach ifile $files {
...
set _xil_proj_name_ "02_Prueba_EMIO"
...
set script_file "02_Prueba_EMIO.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/../02_Prueba_EMIO"]"
...
set file "[file normalize "$origin_dir/../02_Prueba_EMIO/02_Prueba_EMIO.srcs/constrs_1/new/Navigator.xdc"]"
set file_imported [import_files -fileset constrs_1 [list $file]]
set file "new/Navigator.xdc"
...
set_property -name "target_constrs_file" -value "[get_files [list "*new/Navigator.xdc"]]" -objects $obj
set_property -name "target_part" -value "xc7z020clg400-2" -objects $obj
set_property -name "target_ucf" -value "[get_files [list "*new/Navigator.xdc"]]" -objects $obj
...
if { [get_property IS_LOCKED [ get_files -norecurse [list sistema.bd]] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/../02_Prueba_EMIO/02_Prueba_EMIO.gen/sources_1/bd/sistema/hdl/sistema_wrapper.v" ]
} else {
...
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/02_Prueba_EMIO.srcs/utils_1/imports/synth_1" -objects $obj
...
set_property -name "auto_rqs.directory" -value "$proj_dir/02_Prueba_EMIO.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "incremental_checkpoint.more_options" -value "" -objects $obj
set_property -name "include_in_archive" -value "1" -objects $obj
set_property -name "gen_full_bitstream" -value "1" -objects $obj
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/02_Prueba_EMIO.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "min_rqa_score" -value "0" -objects $obj
