...
#
# 04_HolaMundo_QSPI.tcl: Tcl script for re-creating project '04_HolaMundo_QSPI'
#
# Generated by Vivado on Sat Dec 27 15:03:36 +0100 2025
...
#
# 1. This project restoration tcl script (04_HolaMundo_QSPI.tcl) that was generated.
#
...
set _xil_proj_name_ "04_HolaMundo_QSPI"
...
set script_file "04_HolaMundo_QSPI.tcl"
...
if { [get_property IS_LOCKED [ get_files -norecurse [list sistema.bd]] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/04_HolaMundo_QSPI.gen/sources_1/bd/sistema/hdl/sistema_wrapper.v" ]
} else {
...
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/04_HolaMundo_QSPI.srcs/utils_1/imports/synth_1" -objects $obj
...
set_property -name "auto_rqs.directory" -value "$proj_dir/04_HolaMundo_QSPI.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "incremental_checkpoint.more_options" -value "" -objects $obj
set_property -name "include_in_archive" -value "1" -objects $obj
set_property -name "gen_full_bitstream" -value "1" -objects $obj
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/04_HolaMundo_QSPI.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "min_rqa_score" -value "0" -objects $obj
