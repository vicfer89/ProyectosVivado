...
#
# FSBL_Master_Design.tcl: Tcl script for re-creating project 'FSBL_Master_Design'
#
# Generated by Vivado on Sat Dec 27 15:04:32 +0100 2025
...
#
# 1. This project restoration tcl script (FSBL_Master_Design.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "D:/ProyectosVivado/FSBL_Master_Design/FSBL_Master_Design.srcs/utils_1/imports/synth_1/sistema_wrapper.dcp"
#
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/FSBL_Master_Design.srcs/utils_1/imports/synth_1/sistema_wrapper.dcp"]"\
  ]
  foreach ifile $files {
...
set _xil_proj_name_ "FSBL_Master_Design"
...
set script_file "FSBL_Master_Design.tcl"
...
if { [get_property IS_LOCKED [ get_files -norecurse [list sistema.bd]] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/FSBL_Master_Design.gen/sources_1/bd/sistema/hdl/sistema_wrapper.v" ]
} else {
...
set_property -name "incremental_checkpoint" -value "$proj_dir/FSBL_Master_Design.srcs/utils_1/imports/synth_1/sistema_wrapper.dcp" -objects $obj
...
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/FSBL_Master_Design.srcs/utils_1/imports/synth_1" -objects $obj
...
set_property -name "auto_rqs.directory" -value "$proj_dir/FSBL_Master_Design.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "incremental_checkpoint.more_options" -value "" -objects $obj
set_property -name "include_in_archive" -value "1" -objects $obj
set_property -name "gen_full_bitstream" -value "1" -objects $obj
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/FSBL_Master_Design.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "min_rqa_score" -value "0" -objects $obj
